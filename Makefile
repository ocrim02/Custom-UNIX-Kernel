...
SRC = arch/cpu/entry.S kernel/start.c arch/bsp/yellow_led.c lib/utils.c arch/bsp/pl011_uart.c lib/ringbuffer.c arch/bsp/systimer.c arch/cpu/ivt.S arch/cpu/interrupt_handler.c arch/cpu/interrupt_controller.c
